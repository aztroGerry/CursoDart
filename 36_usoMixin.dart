void main() {
  /// otra forma de poder usar clases son los mixin en Dart
  /*                    autor: gerardo garduño 
                        fecha: 18 de diciembre           */
  // uso de los mixin que se pueden heredar muchas veces en diversas clases 
...
class Profesor extends Persona with ValidarRfc{
...
// se podra utilizar dentro de cualquier clase con la palabra with nombre
mixin ValidarRfc{

  validarRfc(String rfc){
    if (rfc.length >= 10){
      print( 'el rfc contiene homoclave');
    }else {
    print('el rfc no contiene homoclave');
    }
  }
}